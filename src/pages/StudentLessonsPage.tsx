...
import { Search, Filter, BookOpen, Calendar, Clock, CheckCircle } from 'lucide-react';
...
export function StudentLessonsPage() {
  ...
  const filteredLessons = studentMockData.allLessons.filter(lesson => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">
            {studentMockData.allLessons.length}
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">
            {Math.round((completedLessons.length / studentMockData.allLessons.length) * 100)}%
          </p>
        </div>
      </div>
