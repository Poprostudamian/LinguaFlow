<label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">
      ...
      {/* Modal Preview/Edit */}
      {lessonModal.isOpen && lessonModal.lesson && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
              <div>
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white">
                  {lessonModal.mode === 'edit' ? '✏️ Edit Lesson' : '👀 Preview Lesson'}: {lessonModal.lesson.title}
                </h2>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  {lessonModal.mode === 'edit' 
                    ? 'Modify lesson details and exercises' 
                    : 'View lesson content and structure'
                  }
                </p>
              </div>
              <button
            ...
            <div className="p-6 overflow-y-auto max-h-[70vh]">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mb-6">
                <h3 className="font-medium text-gray-900 dark:text-white mb-3">📋 Lesson Information</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <span className="text-sm text-gray-600 dark:text-gray-400">Title:</span>
                    <p className="font-medium text-gray-900 dark:text-white">{lessonModal.lesson.title}</p>
                  </div>
                  <div>
                    <span className="text-sm text-gray-600 dark:text-gray-400">Status:</span>
                    <span className={`ml-2 px-2 py-1 rounded-full text-xs font-medium ${
                      lessonModal.lesson.status === 'published' 
                        ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200'
                        : 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200'
                    }`}>
                      {lessonModal.lesson.status}
                    </span>
                  </div>
                  <div>
                    <span className="text-sm text-gray-600 dark:text-gray-400">Created:</span>
                    <p className="text-gray-900 dark:text-white">{new Date(lessonModal.lesson.created_at).toLocaleDateString()}</p>
                  </div>
                  <div>
                    <span className="text-sm text-gray-600 dark:text-gray-400">Assigned Students:</span>
                    <p className="text-gray-900 dark:text-white">{lessonModal.lesson.assignedCount}</p>
                  </div>
                  {lessonModal.lesson.description && (
                    <div className="md:col-span-2">
                      <span className="text-sm text-gray-600 dark:text-gray-400">Description:</span>
                      <p className="text-gray-900 dark:text-white mt-1">{lessonModal.lesson.description}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="mb-6">
                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">
                  🧩 Exercises
                  {lessonModal.mode === 'edit' && (
                    <span className="text-sm font-normal text-gray-500 ml-2">(Full editing coming soon)</span>
                  )}
                </h3>
                ...
                <div className="space-y-4">
                  <div className="border border-gray-300 dark:border-gray-600 rounded-lg p-4 bg-blue-50 dark:bg-blue-900/20">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <h4 className="font-medium text-gray-900 dark:text-white">Sample ABCD Question</h4>
                      <span className="text-sm text-gray-500 dark:text-gray-400">(2 points)</span>
                    </div>
                    <p className="text-gray-700 dark:text-gray-300 mb-3">Which of the following is correct English grammar?</p>
                    <div className="space-y-1">
                      <div className="flex items-center space-x-2 p-2 bg-green-100 dark:bg-green-900/30 rounded border border-green-300 dark:border-green-700">
                        <span className="font-medium">A:</span>
                        <span>I have been living here for 5 years.</span>
                        <span className="text-green-600 dark:text-green-400 text-xs font-medium ml-auto">✓ Correct</span>
                      </div>
                      <div className="flex items-center space-x-2 p-2 bg-gray-100 dark:bg-gray-700 rounded">
                        <span className="font-medium">B:</span>
                        <span>I have been living here since 5 years.</span>
                      </div>
                      <div className="flex items-center space-x-2 p-2 bg-gray-100 dark:bg-gray-700 rounded">
                        <span className="font-medium">C:</span>
                        <span>I am living here since 5 years.</span>
                      </div>
                      <div className="flex items-center space-x-2 p-2 bg-gray-100 dark:bg-gray-700 rounded">
                        <span className="font-medium">D:</span>
                        <span>I live here since 5 years.</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border border-gray-300 dark:border-gray-600 rounded-lg p-4 bg-green-50 dark:bg-green-900/20">
                    <div className="flex items-center space-x-2 mb-2">
                      <span className="text-lg">🃏</span>
                      <h4 className="font-medium text-gray-900 dark:text-white">Sample Flashcards</h4>
                      <span className="text-sm text-gray-500 dark:text-gray-400">(3 points)</span>
                    </div>
                    <p className="text-gray-700 dark:text-gray-300 mb-3">Basic vocabulary practice:</p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div className="bg-white dark:bg-gray-700 p-3 rounded-md border text-center">
                        <div className="font-medium text-gray-900 dark:text-white mb-2">Hello</div>
                        <div className="text-sm text-gray-600 dark:text-gray-400 border-t pt-2">Cześć</div>
                      </div>
                      <div className="bg-white dark:bg-gray-700 p-3 rounded-md border text-center">
                        <div className="font-medium text-gray-900 dark:text-white mb-2">Thank you</div>
                        <div className="text-sm text-gray-600 dark:text-gray-400 border-t pt-2">Dziękuję</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border border-gray-300 dark:border-gray-600 rounded-lg p-4 bg-orange-50 dark:bg-orange-900/20">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <h4 className="font-medium text-gray-900 dark:text-white">Sample Text Question</h4>
                      <span className="text-sm text-gray-500 dark:text-gray-400">(5 points)</span>
                    </div>
                    <p className="text-gray-700 dark:text-gray-300 mb-3">Describe your daily routine in English (100-200 words):</p>
                    <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-md">
                      <span className="text-xs text-gray-600 dark:text-gray-400">Student answer area (max. 500 characters)</span>
                      <div className="mt-2 p-3 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-md min-h-[100px]">
                        <span className="text-sm text-gray-400 italic">Student writes their answer here...</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {lessonModal.mode === 'edit' && (
                <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg border border-yellow-300 dark:border-yellow-700">
                  <p className="text-sm text-yellow-800 dark:text-yellow-200">
                    <strong>Coming Soon:</strong> Full exercise editing capabilities will be added in the next update. 
                    For now, you can view lesson details and plan your exercises structure.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="flex items-center justify-between p-6 border-t border-gray-200 dark:border-gray-700">
              <div className="text-sm text-gray-600 dark:text-gray-400">
                📊 3 sample exercises • 10 points total
              </div>
              <div className="flex gap-3">
                {lessonModal.mode === 'preview' ? (
                  <button
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 py-2 px-4 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                  >
...
}// src/pages/TutorLessonManagementPage.tsx - KOMPLETNA WERSJA
                ...
                {exercises.map((exercise, exerciseIndex) => (
                  <div key={exerciseIndex} className="p-4 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-700">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                      ...
                      <div>
                        <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">
                          // DOKOŃCZENIE KODU z dokumentu - część od linii gdzie się urwało
                        <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">
                          Punkty
                        </label>
                        <input
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
              <div>
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white">
                  {lessonModal.mode === 'edit' ? 'Edit Lesson' : 'Preview Lesson'}: {lessonModal.lesson.title}
                </h2>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  {lessonModal.mode === 'edit' 
                    ? 'Modify lesson details and exercises' 
              ...
              <div key={lesson.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-500 dark:text-gray// DOKOŃCZENIE KODU z dokumentu - część od linii gdzie się urwało
                        <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">
                          Punkty
                        </label>
                        <input
