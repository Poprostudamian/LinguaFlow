// src/pages/TutorStudentsPage.tsx - ORYGINALNA WERSJA Z MOCK DATA
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">
            {tutorMockData.students.reduce((sum, s) => sum + s.totalHours, 0)}h
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">
            {Math.round(tutorMockData.students.reduce((sum, s) => sum + s.progress, 0) / tutorMockData.students.length)}%
          </p>
        </div>
      </div>
