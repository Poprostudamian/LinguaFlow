...
/* Podstawowe style dla viewera treści lekcji */
.lesson-content-viewer {
  line-height: 1.75;
}

/* Wymuszenie kolorów tekstu w dark mode */
.dark .lesson-content-viewer,
.dark .lesson-content-viewer * {
  color: rgb(229, 231, 235) !important; /* gray-200 */
}

/* Wyjątki dla elementów, które powinny zachować swój kolor */
.dark .lesson-content-viewer a {
  color: rgb(147, 197, 253) !important; /* blue-300 */
}

.dark .lesson-content-viewer strong,
.dark .lesson-content-viewer b {
  color: rgb(255, 255, 255) !important; /* white */
  font-weight: 700;
}

.dark .lesson-content-viewer h1,
.dark .lesson-content-viewer h2,
.dark .lesson-content-viewer h3,
.dark .lesson-content-viewer h4,
.dark .lesson-content-viewer h5,
.dark .lesson-content-viewer h6 {
  color: rgb(255, 255, 255) !important; /* white */
  font-weight: 700;
}

/* Style dla list w dark mode */
.dark .lesson-content-viewer ul,
.dark .lesson-content-viewer ol {
  color: rgb(229, 231, 235) !important; /* gray-200 */
}

/* Style dla code blocks w dark mode */
.dark .lesson-content-viewer code {
  background-color: rgb(31, 41, 55) !important; /* gray-800 */
  color: rgb(167, 243, 208) !important; /* emerald-300 */
  padding: 0.125rem 0.25rem;
  border-radius: 0.25rem;
}

.dark .lesson-content-viewer pre {
  background-color: rgb(31, 41, 55) !important; /* gray-800 */
...
.dark .lesson-content-viewer pre code {
  background-color: transparent !important;
  padding: 0;
}

/* Style dla blockquotes w dark mode */
.dark .lesson-content-viewer blockquote {
...
/* Style dla tabel w dark mode */
.dark .lesson-content-viewer table {
  border-color: rgb(75, 85, 99) !important; /* gray-600 */
}

.dark .lesson-content-viewer th {
  background-color: rgb(55, 65, 81) !important; /* gray-700 */
  color: rgb(255, 255, 255) !important; /* white */
  border-color: rgb(75, 85, 99) !important; /* gray-600 */
}

.dark .lesson-content-viewer td {
  border-color: rgb(75, 85, 99) !important; /* gray-600 */
  color: rgb(229, 231, 235) !important; /* gray-200 */
}

/* Style dla obrazków - zapewnij że nie są prześwietlone */
.dark .lesson-content-viewer img {
  border-radius: 0.5rem;
  border: 1px solid rgb(75, 85, 99); /* gray-600 */
}

/* Style dla hr w dark mode */
.dark .lesson-content-viewer hr {
  border-color: rgb(75, 85, 99) !important; /* gray-600 */
}