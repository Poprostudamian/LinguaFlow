// src/components/StudentCard.tsx - Zaktualizowana wersja
    ...
    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow duration-200">
      ...
      <div className="mb-4">
        ...
        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
          <div 
            className={`bg-gradient-to-r ${getProgressColor(student.progress)} h-2 rounded-full transition-all duration-300`}
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="text-center">
          <div className="flex items-center justify-center space-x-1 text-gray-500 dark:text-gray-400">
            ...
            <span className="text-sm">{student.lessonsCompleted}</span>
          </div>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Lessons</p>
        </div>
        <div className="text-center">
          <div className="flex items-center justify-center space-x-1 text-gray-500 dark:text-gray-400">
            <Clock className="h-4 w-4" />
            <span className="text-sm">{student.totalHours}h</span>
          </div>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Study Time</p>
        </div>
      </div>
