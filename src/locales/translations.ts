...
// Tutor Schedule Page
  ...
  // Tutor Students Page
    tutorStudentsPage: {
      ...
      studentSince: 'Your student since',
      active: 'Active',
      inactive: 'Inactive',
      beginner: 'Beginner',
      intermediate: 'Intermediate',
...
// TUTOR ---------------------------------------------------------------------------------------------------------------------
    ...
    tutorStudentsPage: {
      ...
      errorLoadingProfile: 'Nie udało się załadować profilu ucznia',
      close: 'Zamknij',
      totalLessons: 'Wszystkie Lekcje',
      completed: 'Ukończone',
      inProgress: 'W Trakcie',
...
// Ustawienia Tutora
    tutorSettings: {
      title: 'Ustawienia Tutora',
      subtitle: 'Zarządzaj swoim profilem zawodowym i preferencjami nauczania',
      saveChanges: 'Zapisz zmiany',
      saving: 'Zapisywanie...',
      changesSaved: 'Ustawienia zostały zapisane!',
      errorSaving: 'Nie udało się zapisać ustawień',
      errorLoading: 'Nie udało się załadować ustawień',

      // Sekcja Profilu
      profileSection: {
        title: 'Profil Zawodowy',
        description: 'Pokaż swoją wiedzę i doświadczenie w nauczaniu',
        profilePhoto: 'Zdjęcie profilowe',
        uploadHint: 'JPG, PNG lub WEBP (maks. 5MB)',
        ...
        bio: 'Bio zawodowe',
        bioPlaceholder: 'Opowiedz uczniom o swojej filozofii nauczania i doświadczeniu...',
        teachingExperience: 'Doświadczenie w nauczaniu',
        experiencePlaceholder: 'np. 5 lat nauczania angielskiego uczniów szkół średnich...',
        education: 'Wykształcenie',
        educationPlaceholder: 'np. Magister filologii angielskiej, Uniwersytet Warszawski',
        hourlyRate: 'Stawka godzinowa (PLN)',
        rateHint: 'Twoja sugerowana stawka za godzinę lekcji (opcjonalnie)',
        characters: 'znaków',
      },

      // Sekcja Języków
      languagesSection: {
        title: 'Języki Nauczania',
        description: 'Języki, których uczysz lub w których prowadzisz lekcje',
        addLanguage: 'Dodaj język',
        languagePlaceholder: 'Wpisz i naciśnij Enter',
        popularLanguages: 'Popularne języki',
        yourLanguages: 'Twoje języki nauczania',
        noLanguages: 'Nie dodano jeszcze języków nauczania',
      },

      // Sekcja Specjalizacji
      expertiseSection: {
        title: 'Specjalizacje i obszary nauczania',
        description: 'Twoje obszary specjalizacji i mocne strony w nauczaniu',
        addExpertise: 'Dodaj obszar specjalizacji',
        expertisePlaceholder: 'Wpisz i naciśnij Enter (maks. 8)',
        popularExpertise: 'Popularne specjalizacje',
        yourExpertise: 'Twoje obszary specjalizacji',
        noExpertise: 'Nie dodano jeszcze obszarów specjalizacji',
      },

      // Sekcja Uczniów
      studentsSection: {
        title: 'Moi Uczniowie',
        description: 'Uczniowie, których obecnie nauczasz',
        noStudents: 'Nie masz jeszcze żadnych uczniów',
        noStudentsDescription: 'Uczniowie pojawią się tutaj po zaakceptowaniu Twojego zaproszenia',
        active: 'Aktywny',
        inactive: 'Nieaktywny',
        ...
        totalStudents: 'Liczba uczniów',
        activeStudents: 'Aktywni uczniowie',
        totalCompletedLessons: 'Ukończone lekcje',
      },
      ...
      accountSection: {
        ...
        tutorAccount: 'Konto Tutora',
        tutorAccountDescription: 'Możesz tworzyć lekcje i zarządzać uczniami',
        language: 'Język',
        theme: 'Motyw',
        light: 'Jasny',
        dark: 'Ciemny',
        notifications: 'Powiadomienia',
        emailNotifications: 'Powiadomienia Email',
        emailNotificationsDesc: 'Otrzymuj aktualizacje o lekcjach i postępach uczniów',
        pushNotifications: 'Powiadomienia Push',
        ...
        delete: 'Usuń',
        deleteAccountConfirm: 'Czy jesteś pewien?',
        deleteAccountWarning: 'Ta akcja jest nieodwracalna. Wszystkie Twoje dane, lekcje i połączenia z uczniami zostaną trwale usunięte.',
        cancel: 'Anuluj',
